...
public class MusicDollCommon : ModuleRules
{
    public MusicDollCommon(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] {
            ...
            "SequencerScripting",       // Sequencer Scripting (for UMovieSceneSequenceExtensions)
            "Slate",                    // Slate UI库
            "SlateCore",                // Slate核心库
