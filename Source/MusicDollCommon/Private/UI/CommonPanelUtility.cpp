...
TSharedRef<SWidget> FCommonPanelUtility::CreateFilePathPropertyRow(
	const FString& PropertyName,
...
TSharedRef<SWidget> FCommonPanelUtility::CreateSectionHeader(const FString& SectionTitle)
{
...
bool FCommonPanelUtility::BrowseForFile(
	const FString& FileExtension,
	FString& OutFilePath,
	bool bAllowCreateNew)
{
