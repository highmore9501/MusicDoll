...
class MUSICDOLLCOMMON_API SBoneControlMappingEditPanel
   ...
   private:
    ...
    FReply OnApplySelectedControlsOffsetTransformClicked();
    ...
    void OnBoneSelectionChanged(TSharedPtr<FString> InBone,
                                ESelectInfo::Type SelectInfo,
                                TSharedPtr<FBoneControlPair> InPair);

    void OnControlSelectionChanged(TSharedPtr<FString> InControl,
                                   ESelectInfo::Type SelectInfo,
                                   TSharedPtr<FBoneControlPair> InPair);
