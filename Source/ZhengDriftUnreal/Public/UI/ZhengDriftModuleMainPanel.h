...
/**
 * 古筝模块主面板
 * 继承 SModuleMainPanelBase，提供 Properties / Operations / Bone Control Mapping / Bake 四个 Tab
 */
...
public:
    ...
    virtual FString GetModuleName() const override { return TEXT("ZhengDrift"); }
...
private:
    ...
    TSharedPtr<SZhengDriftBakeOperationsPanel> BakeOperationsPanel;
};
